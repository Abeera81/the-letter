...
And the test that holds me to it drops a sentinel into the letter, runs the real pipeline, and asserts it appears **nowhere in the fully serialized request** — not just absent from the prompt string, absent from every field of the body:
